...
from airflow.operators import DownloadOperator, ChecksumOperator, UnzipOperator, GZipOperator
...
def create_provider_dag(
    ...
    download_operator >> checksum_operator >> unzip_operator >> gzip_operator
